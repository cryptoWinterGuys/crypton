	...
	fetch("https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd")
		...
		.then((jsonData) => {
			...
			for (let i = 0; i < coinSet.length; i++) {
				...
				coinData += `<td> ${coinSet[i].circulating_supply} </td>`;
				("<tr>");
				...
				coinData += `<td><a id="learnMoreButton" onclick="location.href='./coin-description.html'" class="btn btn-primary w-100" target="_blank" rel="noopener">Learn more</a></td>`;
			}
